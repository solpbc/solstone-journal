...
| MCP endpoint owner identity, durable PoP key, and bearer-token verifier ledger (`mcp-endpoint/**`) | `core/crates/solstone-core-mcp-endpoint/` (`lib.rs::bootstrap_mcp_endpoint_owner_identity`, `unix.rs`, `tokens.rs`) |
