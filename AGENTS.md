...
| Chronicle-day health markers (`chronicle/<day>/health/stream.updated` writer; `chronicle/<day>/health/daily.updated` remover) | `core/crates/solstone-core-journal-convergence/` after an exact proposed record. No other module writes `stream.updated` from this crate, and no other module unlinks `daily.updated` as the claimed-dirty projection. |
