...
| Segment durable events (`chronicle/**/<seg>/events.jsonl`) | Mixed durable log written by ingest, sense, transcribe, supervisor, and retention's raw-original deletion door. Retention rows are durable-only, never bus-broadcast. |
