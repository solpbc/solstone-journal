...
| Cortex use-id high watermark (`health/cortex-use-id.json`) | `core/crates/solstone-core-journal-io/src/cortex_use/allocation.rs` (`allocate_cortex_use_id`), called by the Cortex client before request publication |
