...
| Timeline (`chronicle/<day>/timeline.json`, `chronicle/**/<seg>/timeline.json`, root `timeline.json`) | `core/crates/solstone-core-timeline/src/{store,binding}.rs` owns all segment, day, and master artifact writes. `solstone-core-maintenance`, `solstone-core-talent-runtime`, and `solstone-core-think-cli` are orchestration callers, not separate writers. |
