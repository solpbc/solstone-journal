...
Everything here ships. Nothing here is source for anything else. The
`solstone/talent/journal/contract/bundle.json` is generated by
`solstone-core contract build` and checked by `make ci-full`. Router skills
use live CLI help for command lists instead of generated command references.
