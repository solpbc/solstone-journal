...
#[tokio::test]
async fn ac1_established_has_exactly_24_reachable_json_get_cases() {
    let corpus = corpus();
    ...
    let get_cases = cases
        ...
        .collect::<Vec<_>>();
    // 24 cases, not 24 routes: `api/icons` is recorded three times because it
