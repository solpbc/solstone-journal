...
#[tokio::test]
async fn ac1_established_has_exactly_20_reachable_json_get_cases() {
    let corpus = corpus();
    ...
    let get_cases = cases
        ...
        .collect::<Vec<_>>();
    // 20 cases, not 20 routes: `api/icons` is recorded three times because it
