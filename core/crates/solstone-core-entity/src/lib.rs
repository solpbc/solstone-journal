...
pub use store::{
    ...
    AmbiguityObservation, CanonicalKeyField, CensusEntity, DEFAULT_ACTIVITY_TS, EncoderIdentity,
    ...
    EntityOperationContext, EntityOperationKind, EntityReviewCandidateError, EntitySaveResult,
    EntityStoreError, EntityUndoError, EntityUndoReport, EntityWriteError,
    ENTITY_REVIEW_POLICY_VERSION, HistoryEntry, HistoryEvent, IdentityCensus,
    IdentityMapCacheLoad, IdentityMapLoser, IdentityMapLoserReason, IdentitySnapshot,
    IncomingObservationRow, JournalEntity, ObservationChange, ObservationEntityResolution,
    ObservationErrorSource, ObservationLookup, ObservationLookupError,
    ...
    PreparedMergeProposals, PreparedObservationBatch, REVIEW_SWEEP_RECEIPT_RELATIVE_PATH, Retired,
    ...
    VoiceprintRemovalReport, VoiceprintSkipReasons, accept_merge_candidate, add_observation, ambiguity_group_revision,
    apply_ambiguity_review_policy, apply_merge_candidate_review_policy, apply_observation_change,
    apply_ops_to_parsed, classify_prepared_history, commit_entity_merge, count_observations,
    ...
    repair_entity_identities, rescope_facet_ambiguities, resolve_ambiguity_group,
    ...
    undo_entity_merge, validate_review_object,
};
pub use trust_lock::{
