...
pub use store::{
    ...
    EntityUndoReport, EntityWriteError, HistoryEntry, HistoryEvent, IdentityCensus,
    ...
    ObservationWriteError, ObservationWriteOutcome, PREFIX_CUTOFF, ParsedObservations,
    PreparedHistoryEvent, PreparedHistoryOutcome, PreparedIdentityChange, PreparedMergeProposals,
    PreparedObservationBatch, REVIEW_SWEEP_RECEIPT_RELATIVE_PATH, Retired, ReviewRestoreTarget,
    TYPO_FLOOR, VoiceprintArchive, VoiceprintEnvelope, VoiceprintItem, VoiceprintKey,
    VoiceprintNpzError, VoiceprintOperationError, VoiceprintRemoval, VoiceprintRemovalReport,
    VoiceprintSkipReasons, accept_merge_candidate, add_observation, ambiguity_group_revision,
