...
pub use store::{
    ...
    PreparedHistoryOutcome, PreparedIdentityChange, PreparedMergeProposals, VoiceprintArchive,
    VoiceprintEnvelope, VoiceprintItem, VoiceprintKey, VoiceprintNpzError,
    ...
    load_resolved_ambiguity_choice, normalize_embedding, prepare_identity_changes,
    ...
    save_voiceprints_batch, try_load_entity_voiceprints_file, try_load_entity_voiceprints_in_dir,
