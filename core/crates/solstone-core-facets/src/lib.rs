...
pub use store::{
    ...
    AwarenessStoreError, BackfillReport, ConnectionsHorizon, DEFAULT_FACET, DeclaredFacetInventory,
    ...
    enrich_relationship_with_journal, ensure_daily_facet_id, ensure_default_facet,
