...
pub use store::{
    ...
    ObservationOperationCounts, ObservationWriteError, ScopedFacetEntity, add_observation,
    block_journal_entity, count_observations, create_facet, delete_created_entity_if_unreferenced,
    delete_detected_entity, delete_facet_entity_link, delete_journal_entity,
    enrich_relationship_with_journal, list_facet_entity_directories, load_all_facet_relationships,
