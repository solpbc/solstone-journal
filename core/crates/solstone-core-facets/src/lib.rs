...
pub use store::{
    ActivityRecord, ActivityRecordStoreError, AppendOutcome, AwarenessStoreError,
    ...
    FacetEntityLinkSnapshot, FacetEntityMoveResult, FacetEntityWriteError, FacetRelationshipRecord,
    FacetRenameError, FacetRenameResult, FacetReviewCandidateError, FacetStoreError,
    FacetWriteError, ObservationEntityResolution, ObservationLookup, ObservationLookupError,
    ...
    activity_value_truthy, add_activity, add_observation, append_activity_record, append_log,
    ...
    dismiss_candidate, enrich_relationship_with_journal, extract_spoken_names, facet_slug,
    get_activity_record, is_speakable, list_declared_facet_names, list_facet_directories,
    ...
    load_observations_for_query, load_recent_entity_names, observation_day_counts,
    read_activity_file, read_detected_entities, read_facet_declaration, read_facet_entity_link,
