...
pub use store::{
    ...
    accept_candidate, add_observation, block_journal_entity, count_observations, create_facet,
    delete_created_entity_if_unreferenced, delete_detected_entity, delete_facet_entity_link,
    delete_journal_entity, dismiss_candidate, enrich_relationship_with_journal,
    extract_spoken_names, facet_slug, is_speakable, list_facet_entity_directories,
    load_all_attached_entities, load_all_facet_relationships,
    load_all_facet_relationships_across_facets, load_candidates, load_detected_entities_recent,
