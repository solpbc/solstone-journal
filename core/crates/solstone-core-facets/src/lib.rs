...
pub use store::{
    ...
    AwarenessStoreError, BackfillReport, ConnectionsHorizon, DeclaredFacetInventory,
    ...
    FacetIdResolveError, FacetIdentityError, FacetRelationshipRecord, FacetRenameError,
    FacetRenameResult, FacetReviewCandidateError, FacetStoreError, FacetWriteError, HistoryEntry,
    ...
    activity_value_string, activity_value_truthy, add_activity, add_observation,
    admit_activity_destination, allocate_facet_id, allocate_facet_id_locked,
    append_activity_record, append_edit, append_log, apply_observation_change, assign_new_facet_id,
    ...
    enrich_relationship_with_journal, ensure_daily_facet_id, extract_spoken_names, facet_slug,
    facet_write_identity, get_activity_record, hold_activity_enrichment, humanize_facet_title,
    is_speakable, is_well_formed_facet_id, list_declared_facet_names, list_facet_directories,
    list_facet_entity_directories, load_activity_records, load_all_attached_entities,
    load_all_facet_relationships, load_all_facet_relationships_across_facets, load_candidates,
    load_current, load_detected_entities_recent, load_imports, load_observations_for_query,
    ...
    read_activity_file, read_detected_entities, read_detected_entities_strict,
    read_detected_entity_names_strict, read_facet_declaration, read_facet_entity_link,
    read_facet_entity_observations, read_live_observations, read_log, read_log_file,
    ...
    set_facet_entity_link_detached, set_facet_muted, strip_incoming_facet_id, update_activity,
