...
pub use store::{
    ...
    PreparedReviewPromotion, RETIRED_FACETS_FILE, Retired, RetiredFacet, RetiredFacetState,
    ...
    allocate_facet_id, allocate_facet_id_locked, append_activity_record, append_edit, append_log,
