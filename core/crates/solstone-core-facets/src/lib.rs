...
pub use store::{
    ...
    FacetEntityLinkReport, FacetEntityLinkSnapshot, FacetEntityMoveResult, FacetEntityWriteError,
    ...
    SeedEntityOutcome, accept_candidate, add_activity, add_observation, append_log,
    ...
    is_speakable, list_facet_directories, list_facet_entity_directories,
