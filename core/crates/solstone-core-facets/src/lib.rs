...
pub use store::{
    ...
    read_news_file, read_todo_file, record_facet_candidates, record_observation_ops,
    ...
    set_facet_entity_link_detached, set_facet_muted, update_activity, update_detected_entity,
