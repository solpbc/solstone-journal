...
/// Read todo JSONL bytes without modeling or mutating todo records.
pub fn read_todo_file(
    journal_root: &Path,
    facet_dir: &str,
    relative_path: &str,
...
/// Atomically replace todo JSONL bytes without modeling or mutating todo records.
