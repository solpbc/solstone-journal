...
Non-owned rows were not edited. `solstone-ci validate` after the shrink: pass
(625 findings).
...
| 5 | `solstone-ci validate` | 0 | 156 Cargo integration targets, 126 package scopes, 13 named legs, 625 routine-boundary findings |
