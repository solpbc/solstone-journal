...
fn classified_same_crate_topology_is_complete_and_nonduplicating() {
    ...
    assert_eq!(routine_tests, 385, "routine annotation census drifted");
    assert_eq!(full_tests, 504, "classified full annotation census drifted");
    ...
    assert_eq!(routine_tests + full_tests + integration_tests, 955);
