...
fn lane_env(
    ...
    let cc_wrapper = wrapper_dir.join(format!("zigcc-{zig_target}"));
    let cxx_wrapper = wrapper_dir.join(format!("zigcxx-{zig_target}"));
    let ar_wrapper = wrapper_dir.join(format!("zigar-{zig_target}"));
    let ranlib_wrapper = wrapper_dir.join(format!("zigranlib-{zig_target}"));
