...
use crate::{HashedFrame, WinnowConfig, WinnowCounters, WinnowState, WinnowVerdict, dhash};
        ...
        match decoder.receive_frame(&mut decoded) {
            Ok(()) => {
                ...
                *frame_id += 1;
                ...
                if transform.apply(*frame_id, timestamp, &mut frame) == PreHashOutcome::Reject {
                    continue;
                }
...
mod tests {
    ...
    use super::{
        IdentityTransform, PreHashOutcome, PreHashTransform, RgbFrame, process_video,
        process_video_with_transform,
    };
    use crate::{WinnowConfig, dhash, format_dhash};
