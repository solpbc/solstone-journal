    ...
    assert_eq!(
        ...
        PruneAssessment::PinnedBy {
            owners: vec![
                ...
                PinOwner::Release("2.0.10".to_owned()),
                PinOwner::Release("2.0.11".to_owned()),
                ...
                PinOwner::Release("2.0.16".to_owned()),
                PinOwner::Release("2.0.17".to_owned()),
                PinOwner::Release("2.0.18".to_owned()),
                ...
                PinOwner::Release("2.0.8".to_owned()),
                PinOwner::Release("2.0.9".to_owned()),
