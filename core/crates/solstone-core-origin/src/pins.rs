...
const SNAPSHOTS: &[(&str, &str)] = &[
    ...
    ("2.0.0", include_str!("../pins/v2.0.0.json")),
    ("2.0.1", include_str!("../pins/v2.0.1.json")),
    ("2.0.3", include_str!("../pins/v2.0.3.json")),
    ("2.0.4", include_str!("../pins/v2.0.4.json")),
    ("2.0.5", include_str!("../pins/v2.0.5.json")),
    ("2.0.6", include_str!("../pins/v2.0.6.json")),
    ("2.0.7", include_str!("../pins/v2.0.7.json")),
    ("2.0.8", include_str!("../pins/v2.0.8.json")),
    ("2.0.9", include_str!("../pins/v2.0.9.json")),
    ("2.0.10", include_str!("../pins/v2.0.10.json")),
    ("2.0.11", include_str!("../pins/v2.0.11.json")),
    ("2.0.12", include_str!("../pins/v2.0.12.json")),
    ("2.0.13", include_str!("../pins/v2.0.13.json")),
    ...
    ("2.0.18", include_str!("../pins/v2.0.18.json")),
