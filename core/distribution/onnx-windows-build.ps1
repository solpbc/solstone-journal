...
try {
    ...
    $sourceRoot = Join-Path $WorkRoot 'source'; $mirrorRoot = Join-Path $WorkRoot 'mirror'; $cmakeRoot = Join-Path $WorkRoot 'cmake'; $pythonRoot = Join-Path $WorkRoot 'python'; $protocRoot = Join-Path $WorkRoot 'protoc'; $flatbuffersRoot = Join-Path $WorkRoot 'flatbuffers'
    New-Item -ItemType Directory -Path $sourceRoot, $mirrorRoot, $cmakeRoot, $pythonRoot, $protocRoot, $flatbuffersRoot | Out-Null
