...
- The topology validator has no baseline or allowlist. It rejects every
  ...
  `/var/tmp`, Cargo offline, and executes the convey page runner inside the sandbox. On macOS, the same Rust checks run locked and
