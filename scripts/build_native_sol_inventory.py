...
RETIRED_JOURNAL_ORACLE_PATHS = {
    ...
    ("import", "resolve-config-all"),
    ("import", "resolve-entity"),
    ("import", "resolve-staged-facet"),
}
...
ADDITIONAL_NATIVE_ORACLE_ENTRIES: list[dict[str, Any]] = [
    ...
    {
        "path": ["speakers", "backfill-status"],
        "kind": "command",
        "help": "Show status of a speaker attribution backfill operation.",
        "params": [
            {
                "name": "operation_id",
                "kind": "argument",
    ...
    {
        "path": ["speakers", "backfill-resume"],
        "kind": "command",
        "help": "Resume an interrupted or failed speaker attribution backfill operation.",
        "params": [
            {
                "name": "operation_id",
                "kind": "argument",
