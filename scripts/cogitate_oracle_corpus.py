...
POLICY_CASES: list[tuple[str, str, str, str | None, str, str]] = [
    ...
    ("shlex_split_raises_trailing_backslash", "sol x" + BS, "normal", None,
    ...
    ("backslash_literal_inside_single_quotes",
     "sol call entities search --name 'a" + BS + "'", "normal", None,
    ...
    ("escaped_dquote_inside_dquotes",
     'sol call entities search --name "a' + BS + '"b"', "normal", None,
     "cogitate_policy.py:143-149", "inside double quotes a backslash DOES escape"),
    ...
    ("repair_quote_apostrophe", "journal facet set \"it's mine\"", "normal", None,
     "cogitate_policy.py:167-170", "shlex.quote's apostrophe form is not the obvious one"),
    ("repair_quote_empty_string", "journal facet set ''", "normal", None,
     "cogitate_policy.py:167-170", "an empty argument must survive as ''"),
    ("repair_quote_safe_chars", "journal facet set a/b.c@d=e:f,g+h-i%j", "normal", None,
     "cogitate_policy.py:167-170", "shlex.quote leaves [-\\w@%+=:,./] UNQUOTED"),
    ("repair_quote_unsafe_star", "journal facet set 'a*b'", "normal", None,
     "cogitate_policy.py:167-170", "a glob char forces quoting"),
    ("repair_quote_unsafe_tilde", "journal facet set 'a~b'", "normal", None,
     "cogitate_policy.py:167-170", "a tilde forces quoting"),
    ("repair_quote_unsafe_brace", "journal facet set 'a{b'", "normal", None,
     "cogitate_policy.py:167-170", "a brace forces quoting"),
    ("repair_quote_search_family", "journal search 'two words'", "normal", None,
     "cogitate_policy.py:167-170", "the search family's repair prefix differs from facet's"),
...
EMIT_FINAL_CASES: list[tuple[str, dict[str, Any], str]] = [
    ...
    ("final_output_path_zero", {"output_path": 0}, "cogitate_contract.py:113 - bool(0) is False"),
    ("final_output_path_empty_list", {"output_path": []}, "cogitate_contract.py:113 - bool([]) is False"),
    ("final_output_path_empty_dict", {"output_path": {}}, "cogitate_contract.py:113 - bool({}) is False"),
    ("final_output_path_zero_string", {"output_path": "0"}, "cogitate_contract.py:113 - a non-empty string is True"),
    ("final_schedule_none", {"schedule": None}, "cogitate_contract.py:114"),
    ("final_all_three", {"diagnostic": True, "output_path": "/x", "schedule": "daily"},
