...
require_platform_receipt JOURNAL_WIN_CI_MANAGED_PROCESS_FACADE
require_platform_receipt JOURNAL_WIN_CI_TARGET_WINDOWS_PAYLOAD
require_platform_receipt JOURNAL_WIN_CI_TARGET_WINDOWS_CREATE_ONLY
require_platform_receipt JOURNAL_WIN_CI_TARGET_WINDOWS_CREATE_ONLY_PROTOCOL
require_platform_receipt JOURNAL_WIN_CI_TARGET_WINDOWS_INSTALL_FILE
...
echo "JOURNAL_WIN_HOST_CI_VERIFIED commit=$snapshot_sha cargo_lock_sha256=$cargo_lock_sha256 cloud_sync_evidence=$expected_cloud_evidence ordinary_owner_evidence=passed launch_environment_preparation=executed/pass launch_path_preparation=executed/pass job_list_no_handle_inheritance=executed/pass job_process_owner=executed/pass job_last_handle_negative=executed/pass managed_process_facade=executed/pass windows_payload=executed/pass windows_create_only=executed/pass windows_create_only_protocol=executed/pass windows_install_file=executed/pass windows_install_file_protocol=executed/pass windows_oplog_namespace=executed/pass ntfs_publication=executed/pass refs_publication=executed/pass ntfs_cortex_use=executed/pass refs_cortex_use=executed/pass ntfs_stale_heartbeat_cleanup=executed/pass refs_stale_heartbeat_cleanup=executed/pass"
