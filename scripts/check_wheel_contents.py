...
CORE_REQUIRED_SDIST_MEMBERS = {
    ...
    "core/crates/solstone-core-sol-client/native/apps/awareness/command.rs",
    "solstone/apps/body/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/body/command.rs",
    "solstone/apps/chat/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/chat/command.rs",
    "solstone/apps/entities/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/entities/command.rs",
    "solstone/apps/facets/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/facets/command.rs",
    "solstone/apps/import/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/import/command.rs",
    "solstone/apps/network/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/network/command.rs",
    "solstone/apps/settings/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/settings/command.rs",
    "solstone/apps/sol/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/sol/command.rs",
    "solstone/apps/speakers/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/speakers/command.rs",
    "solstone/apps/support/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/support/command.rs",
    "solstone/apps/thinking/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/thinking/command.rs",
    "solstone/apps/transcripts/native/authority.toml",
    "core/crates/solstone-core-sol-client/native/apps/transcripts/command.rs",
    "solstone/think/native/chat/authority.toml",
    "core/crates/solstone-core-sol-client/native/think/chat/command.rs",
    "solstone/think/native/import/authority.toml",
    "core/crates/solstone-core-sol-client/native/think/import/command.rs",
    "solstone/think/native/link/authority.toml",
    "core/crates/solstone-core-sol-client/native/think/link/command.rs",
    "solstone/think/native/moved/authority.toml",
    "core/crates/solstone-core-sol-client/native/think/moved/command.rs",
    "solstone/think/native/status/authority.toml",
    "core/crates/solstone-core-sol-client/native/think/status/command.rs",
    "solstone/think/tools/native/health/authority.toml",
    "core/crates/solstone-core-sol-client/native/tools/health/command.rs",
    "solstone/think/tools/native/journal/authority.toml",
    "core/crates/solstone-core-sol-client/native/tools/journal/command.rs",
    "solstone/think/tools/native/ledger/authority.toml",
    "core/crates/solstone-core-sol-client/native/tools/ledger/command.rs",
    "solstone/think/tools/native/profile/authority.toml",
    "core/crates/solstone-core-sol-client/native/tools/profile/command.rs",
}
CORE_TAG_PLATFORMS = {
